...
// 怪物名称
RESET_ONUPDATE_VAR(EnemyName, "天鹿")
// 任务名称
RESET_ONUPDATE_VAR(Name, "天鹿")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "$(消灭银杏)")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "天鹿角是非常珍贵的药物，帮我打猎收集一些。")
// 交任务NPC
RESET_ONUPDATE_VAR(CompleteNpc, 7)
// 副本id
RESET_ONUPDATE_VAR(FubenId, 25)
// 交任务对话
RESET_ONUPDATE_VAR(CompleteTalk, "天鹿角收集齐了么？")
// 追踪Npc
RESET_ONUPDATE_VAR(FollowNpc, 9)
// 经验奖励
RESET_ONUPDATE_VAR(Exp, 47000)
// 金钱奖励
RESET_ONUPDATE_VAR(Money, 100000)
// 交任务菜单选项
...
// 任务描述
RESET_ONUPDATE_VAR(Desc, "消灭40只天鹿")
// 接任务NPC
RESET_ONUPDATE_VAR(AcceptNpc, 7)
// 任务id
RESET_ONUPDATE_VAR(Id, "40021")
// 最低等级
