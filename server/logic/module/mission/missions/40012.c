...
// 任务名称
RESET_ONUPDATE_VAR(Name, "捣乱的小妖（一）")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "$(通关麒麟崖一)")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "麒麟崖的小妖们时常来镇上捣乱，帮我除掉一些，减少他们的数量。")
// 交任务NPC
...
// 经验奖励
RESET_ONUPDATE_VAR(Exp, 43400)
// 金钱奖励
RESET_ONUPDATE_VAR(Money, 96000)
// 交任务菜单选项
...
// 任务描述
RESET_ONUPDATE_VAR(Desc, "通关20次麒麟崖一")
// 接任务NPC
RESET_ONUPDATE_VAR(AcceptNpc, 7)
// 任务id
RESET_ONUPDATE_VAR(Id, "40012")
// 最低等级
