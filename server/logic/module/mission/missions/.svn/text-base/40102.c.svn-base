...
// 怪物名称
RESET_ONUPDATE_VAR(EnemyName, "无劫山二")
// 任务名称
RESET_ONUPDATE_VAR(Name, "清理毒物（二）")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "$(通关无劫山二)")
// 接任务菜单选项
...
// 任务描述
RESET_ONUPDATE_VAR(Desc, "通关20次无劫山二")
// 接任务NPC
RESET_ONUPDATE_VAR(AcceptNpc, 8)
// 任务id
RESET_ONUPDATE_VAR(Id, "40102")
// 最低等级
