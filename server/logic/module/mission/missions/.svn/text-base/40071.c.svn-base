...
// 怪物名称
RESET_ONUPDATE_VAR(EnemyName, "巫族巫师")
// 任务名称
RESET_ONUPDATE_VAR(Name, "巫族巫师")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "$(消灭巫族巫师)")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "巫族巫师凶暴残忍、威胁极大，帮我消灭他们。")
// 交任务NPC
RESET_ONUPDATE_VAR(CompleteNpc, 8)
// 副本id
RESET_ONUPDATE_VAR(FubenId, 29)
// 交任务对话
RESET_ONUPDATE_VAR(CompleteTalk, "巫族巫师除掉了么？")
// 追踪Npc
RESET_ONUPDATE_VAR(FollowNpc, 9)
// 经验奖励
RESET_ONUPDATE_VAR(Exp, 63600)
// 金钱奖励
RESET_ONUPDATE_VAR(Money, 121000)
// 交任务菜单选项
...
// 任务描述
RESET_ONUPDATE_VAR(Desc, "消灭40名巫族巫师")
// 接任务NPC
RESET_ONUPDATE_VAR(AcceptNpc, 8)
// 任务id
RESET_ONUPDATE_VAR(Id, "40071")
// 最低等级
