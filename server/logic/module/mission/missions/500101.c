...
// 前置任务
RESET_ONUPDATE_VAR(PreId, "5010")
// 任务类型
RESET_ONUPDATE_VAR(Type, TYPE_EXT)
// 目标数量
RESET_ONUPDATE_VAR(TargetNum, 20)
// 任务名称
RESET_ONUPDATE_VAR(Name, "龙门切磋（3）")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "前往$(天地龙门三)与水护者切磋武艺")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "英雄左右无事，不如再去找龙门的水护者切磋切磋技艺吧，也可多学几招。")
// 交任务Npc
RESET_ONUPDATE_VAR(CompleteNpc, 15)
// 副本id
RESET_ONUPDATE_VAR(FubenId, 22)
// 交任务对话
RESET_ONUPDATE_VAR(CompleteTalk, "英雄果然威武，竟能多次挫败水护者。")
// 追踪Npc
RESET_ONUPDATE_VAR(FollowNpc, 16)
// 经验奖励
RESET_ONUPDATE_VAR(Exp, 154400)
// 金钱奖励
...
// 任务id
RESET_ONUPDATE_VAR(Id, "500101")
// 任务描述
RESET_ONUPDATE_VAR(Desc, "与水护者切磋技艺。")
