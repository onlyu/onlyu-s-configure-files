...
// 任务名称
RESET_ONUPDATE_VAR(Name, "龙门切磋（2）")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "前往$(天地龙门二)与地护者切磋武艺")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "英雄左右无事，不如再去找龙门的地护者切磋切磋技艺吧，也可多学几招。")
// 交任务Npc
RESET_ONUPDATE_VAR(CompleteNpc, 15)
// 副本id
RESET_ONUPDATE_VAR(FubenId, 21)
// 交任务对话
RESET_ONUPDATE_VAR(CompleteTalk, "英雄果然威武，竟能多次挫败地护者。")
// 追踪Npc
...
// 任务id
RESET_ONUPDATE_VAR(Id, "50092")
// 任务描述
RESET_ONUPDATE_VAR(Desc, "与地护者切磋技艺。")
