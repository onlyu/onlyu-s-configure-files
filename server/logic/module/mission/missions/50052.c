...
// 怪物名称
RESET_ONUPDATE_VAR(EnemyName, "巫妖尖兵")
// 任务名称
RESET_ONUPDATE_VAR(Name, "修理巫妖尖兵")
// 追踪文本
RESET_ONUPDATE_VAR(FollowText, "前往$(踏仙台二)修理巫妖尖兵")
// 接任务菜单选项
RESET_ONUPDATE_VAR(AcceptOption, "我这就去。")
// 接任务对话
RESET_ONUPDATE_VAR(AcceptTalk, "近日巫族出没，在渔村烧杀抢掠，实在可恨之极。英雄如此骁勇，能帮我们教训一下那些奇形怪状的巫妖尖兵吗？")
// 交任务Npc
...
// 任务id
RESET_ONUPDATE_VAR(Id, "50052")
// 任务描述
RESET_ONUPDATE_VAR(Desc, "去教训巫妖尖兵。")
