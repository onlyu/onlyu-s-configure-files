#ifndef _rc_rpc_confirm_dlg
#define _rc_rpc_confirm_dlg
...
void rpc_client_show_confirm_dialog(int uid, class msg_confirm_dialog_s info) { fs_rpc_call(uid, RPC_CLIENT_SHOW_CONFIRM_DIALOG, info); }
