...
*** TODO learn more about cscope
** TODO read emacs document [0/1]
*** TODO emacs lisp tutorial

** TODO fly-make in lpc						  :important:
...
** mount ssh files to local directory
* read book [0/2]
** TODO hacks
** TODO org-manual
* hack [0/1]
** TODO make xcscope.el more ease to use [0/2]
*** TODO change the key mapping
