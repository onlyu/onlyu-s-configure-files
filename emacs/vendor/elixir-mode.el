...
;; Keywords: languages Elixir;; Version: 1.0.0

;; This file is not a part of GNU Emacs.

;; This program is free software; you can redistribute it and/or modify-face;; it under the terms of the GNU General Public License as published by
;; the Free Software Foundation; either version 2, or (at your option)
;; any later version.

;; This program is distributed in the hope that it will be useful,
;; but WITHOUT ANY WARRANTY; without even the implied warranty of-flymake-error;; MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
...
(defconst elixir-mode-font-lock-defaults
  (list
    ...
    `(,(concat "\\<" (regexp-opt elixir-mode-keyword-names t) "\\>") . font-lock-keyword-face)                                          ; keywords.    `(,(concat "\\<" (regexp-opt elixir-mode-builtin-names t) "\\>") . font-lock-builtin-face)                                          ; builtins.    `(,(concat "\\<" (regexp-opt elixir-mode-module-names t) "\\>") . font-lock-type-face)                                              ; core modules
