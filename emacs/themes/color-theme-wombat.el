...
(defun color-theme-wombat ()
  ...
  (color-theme-install
   '(color-theme-wombat
     ...
     (default ((t (:stipple nil background "black" :foreground "green" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 150 :width normal :foundry "outline" :family "Terminus"))))
     (ac-candidate-face ((t (:background "#444444" :foreground "green"))))
...
;     (menu ((t (:foreground "systemmenu" :background "systemmenutext"))))
     ...
     (org-agenda-column-dateline ((t (:family "Terminus" :weight normal :slant normal :underline nil :strike-through nil :background "grey90" :height 150))))
     ...
     (org-column ((t (:background "grey90" :strike-through nil :underline nil :slant normal :weight normal :height 150 :family "Terminus"))))
